...
// let labels = [
//     "idc_front", "idc_back", "bank_card", "selfie", "aeroplane", "bus", "train", "truck", "boat", "traffic light",
...
let masks: [[Float]] = [[0, 1, 2], [3, 4, 5], [6, 7, 8]]
...
func nonMaxSuppression(boxes: [Inference], limit: Int, threshold: Float) -> [Inference] {
